...
class Plotter:
    def __init__(self, a_the_mesh:Mesher = None, a_the_fields:Fields = None):
        self.msh = a_the_mesh
    ...
    def plot_mesh(self):
        ...
        fig.update_layout( title={
                          ...
                          font={'size':28})
        fig.show()
        pio.write_image(fig, files_output_path + 'Mesh.png', width=2864, height=1356)
    ...
    def plot_stream_lines(self):
        ...
        fig.layout.update({'title': 'Streamlines'},
                          font={'size':28})
        fig.show()
        pio.write_image(fig, files_output_path + 'Streamlines.png', width=2864, height=1356)
    ...
    def plot_pressure(self, p_cp=False, p_relative=False):
        ...
        fig.show()
        pio.write_image(fig, files_output_path + 'Pressure.png', width=2864, height=1356)
    ...
    def plot_temperature(self, p_relative=False):
        ...
        fig.show()
        pio.write_image(fig, files_output_path + 'Temperature.png', width=2864, height=1356)
    ...
    def plot_rho(self, p_relative=False):
        ...
        fig.show()
        pio.write_image(fig, files_output_path + 'Density.png', width=2864, height=1356)
    ...
    def plot_error_vs_iterations(self, a_solver: SolverGaussSeidelPsi):
        ...
        fig.show()
        pio.write_image(fig, files_output_path + 'Error_vs_Iteration.png', width=2864, height=1356)
    ...
    def plot_numerical_vs_analytical_contour(self):
        ...
        fig.show()
        pio.write_image(fig, files_output_path + 'Numerical_vs_Analytical_Psi.png', width=2864, height=1356)